...
results['1-fit-log-token_based'] = fitness_eval_TOKEN_BASED
fitness_eval_ALIGNMENT_BASED = replay_fitness_evaluator.apply(
    log, net, 
    initial_marking, final_marking,
    variant=replay_fitness_evaluator.Variants.ALIGNMENT_BASED)
results['1-fit-log-alignment_based'] = fitness_eval_ALIGNMENT_BASED
...
fitness_eval_TOKEN_BASED = replay_fitness_evaluator.apply(
    ...
    initial_marking, final_marking,
    variant=replay_fitness_evaluator.Variants.TOKEN_BASED)
results['2-fit-log_alfons_small-token_based'] = fitness_eval_TOKEN_BASED
fitness_eval_ALIGNMENT_BASED = replay_fitness_evaluator.apply(
    log_alfons_small, net, 
    initial_marking, final_marking,
    variant=replay_fitness_evaluator.Variants.ALIGNMENT_BASED)
results['2-fit-log_alfons_small-alignment_based'] = fitness_eval_ALIGNMENT_BASED
